        ...
        <div className="container mx-auto grid justify-center gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div className="flex flex-col items-center p-4">
            <svg
              ...
              className="lucide lucide-earth-lock dark:text-violet-400 w-12 h-12"
            >
          ...
          <div className="flex flex-col items-center p-4">
            <svg
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className="lucide lucide-bitcoin w-12 h-12 dark:text-violet-400"
            >
          ...
          <div className="flex flex-col items-center p-4">
            <svg
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className="lucide lucide-headset   w-12 h-12 dark:text-violet-400"
            >
